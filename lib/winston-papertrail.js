 ...
 *
 * @param {Function}    [options.formatter]     function to format your log message before sending
 *
...
var Papertrail = exports.Papertrail = function (options) {
    ...
    self.prettyPrint = options.prettyPrint || false;
    self.label = options.label || null;
    self.depth = options.depth || null;
    self.showLevel = options.showLevel === undefined ? true : options.showLevel;
...
Papertrail.prototype.name = 'Papertrail';
...
Papertrail.prototype.log = function (level, msg, meta, callback) {
    ...
    if (!this.loggingEnabled || this.silent) {
